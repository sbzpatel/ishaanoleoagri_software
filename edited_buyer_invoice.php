...
$product_id_list = $_POST['product_id'];
	...
	foreach($contract_id_list as $contract_id)
	{
		foreach($product_id_list as $product_id)
		{
			...
			$mysql_update_invoice_contract_products1="update buyer_invoice_products set total_amount='$total_amount' where contract_number='$contract_id' AND product_id='$product_id' AND invoice_number ='$invoice_number'";
	...
	$update_buyer_invoice_gross_amount="update buyer_invoice set gross_amount='$net_amount' where number='$invoice_number'";
