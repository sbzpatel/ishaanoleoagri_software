  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View Invoice Details (Seller)</li>
      </ol>
    </section>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> View Invoice Details (Seller)		
          </h2>
        </div>
        <!-- /.col -->
      </div>
     ...
     <?php
		...
		$view_invoice_sql="select * from seller_invoice where number='$invoice_number'";
	 ...
	 ?>
        ...
        <div class="col-xs-5">
				<div class="table-responsive">
					<table class="table">
								  ...
								  <tr>
											<th>Invoice Date:</th>
											<td><?php echo $view_invoice_row['seller_date'];?></td>
								  </tr>
								  <tr>
											<th>Company Name:</th>
											<td><?php echo $view_invoice_row['seller_name'];?></td>
								  </tr>
								  <tr>
											<th>Net Amount:</th>
	  ...
	  <div class="box-footer">
				   <a class="btn btn-danger fa fa-upload" href="seller_invoice_vieww.php?invoice_number=<?php echo $invoice_number; ?>"> DOWNLOAD PROVISIONAL INVOICE</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <a class="btn btn-danger fa fa-upload" href="seller_invoice_vieww1.php?invoice_number=<?php echo $invoice_number; ?>"> DOWNLOAD FINAL INVOICE</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <a class="btn btn-danger fa fa-upload" href="seller_invoice_view.php?invoice_number=<?php echo $invoice_number; ?>"> SEND PROVISIONAL INVOICE</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <a class="btn btn-danger fa fa-upload" href="seller_invoice_view1.php?invoice_number=<?php echo $invoice_number; ?>"> SEND FINAL INVOICE</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <!--a class="btn btn-danger fa fa-send" href="seller_invoice_send.php?invoice_number=<?php echo $invoice_number; ?>" name="send_mail"> SEND MAIL</a-->  
       </div>
