<?php 
	...
	header('Location:index.php');
		...
		if ($normal == 'Normal')
		{
		$html.='<h3 align="center"><u>CONTRACT CONFIRMATION</u></h3>';
		} else
		{
		...
		<td width="25%" style="border: 0.1mm solid #888888; ">
		   <span style="font-size:8pt; color: #000000; font-family: calibri; text-transform:uppercase;">Contract Number : CN-'.$contract_id.' </span>
		</td>
		<td width="50%" style="border: 0.1mm solid #888888;">
		<span style="font-size:8pt; color: #000000; font-family: calibri; text-transform:uppercase;">Kind Attention : '.$seller_contact_person.' & '.$buyer_contact_person.'</span>
		</td>
		<td width="25%" style="border: 0.1mm solid #888888;">
		<span style="font-size:8pt; color: #000000; font-family: calibri; text-transform:uppercase;">Contract Date : '.$contract_date.'</span>
		</td></tr></table>';
		...
		$filename = "Contract No. ".$contract_id." ".$seller_name." / ".$buyer_name.".pdf";
		$html.='
		<table width="100%" class="table table-bordered" style="font-family: calibri;" cellpadding="10">
		<tr>
		<td width="33%" style="background-color:white; text-align:center;">
		   <span style="font-size:8pt; color: #000000; font-family: calibri;">SELLER<br>'.$seller_name.'<br><br><br><br><br>____________________________</span>
		</td>

		<td width="33%" style="background-color:white; text-align:center; ">
		   <span style="font-size:8pt; color: #000000; font-family: calibri;">INDENTOR<br>ISHAAN OLEO & AGRI RESOURCES<br><br><br><img src="images/sign.jpg" width="150" height="auto"/><br>____________________________</span> 
		</td>

		<td width="33%" style="background-color:white; text-align:center; ">
		   <span style="font-size:8pt; color: #000000; font-family: calibri;">BUYER<br>'.$buyer_name.'<br><br><br><br><br>____________________________</span>
		</td>
