...
$invoice_date = $view_invoice_row['seller_date'];
$invoice_seller_name = $view_invoice_row['seller_name'];
$invoice_gross_amount = $view_invoice_row['gross_amount'];
$invoice_payment_status = $view_invoice_row['payment_status'];

	$sqll = "select email from seller where name='$invoice_seller_name'";
...
$mail = new PHPMailer;
 ...
 $mail->isSMTP();                                      // Set mailer to use SMTP
  ...
  // $mail->Host = 'bh-in-1.webhostbox.net';  // Specify main and backup SMTP servers
   ...
   /* end */
	$mail->setFrom($from);
	$mail->addAddress($to, $invoice_seller_name);     // Add a recipient
	$mail->addReplyTo($from, $invoice_seller_name);
	...
	$mail->Body    .= "Company Name : " .$invoice_seller_name."<br>";
