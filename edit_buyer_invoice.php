  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Invoice (Buyer)</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Invoice (Buyer)</h3>
            </div>
            <!-- /.box-header -->
            ...
            <!-- form start -->
            <form role="form" action="edited_buyer_invoice.php" method="post">
              <div class="box-body">
			  
				<div class="form-group">
				<label for="exampleInputEmail1">Buyer Name</label>
                  <select class="form-control" name="buyer_id" id="buyer_id" onchange="show_sellers_contract()">
					<?php 	$invoice_buyer_names_sql="SELECT * from buyer_invoice where number='$invoice_number'";
							$result=mysql_query($invoice_buyer_names_sql);
							$mysql_fetch = mysql_fetch_assoc($result);
							$invoice_buyer_name = $mysql_fetch['buyer_name'];
							$invoice_buyer_number = $mysql_fetch['number'];
							$invoice_buyer_date = $mysql_fetch['date'];
					?>
				  <option value="<?php echo $invoice_buyer_number;?>" disabled selected><?php echo $invoice_buyer_name; ?></option>
				...
				<input type="text" class="form-control" id="invoice_date" name="invoice_date" placeholder="YYYY-MM-DD" value="<?php echo $invoice_buyer_date; ?>" required readonly>
                </div>
					...
					?>
						 ...
						 <?php 
									...
									while($contract_number_roww=mysql_fetch_array($view_contractss_sql))
									{
										...
										$seller_name_sql=mysql_query("SELECT * FROM `buyer` where id='$contract_seller_id'");
										$seller_name_row=mysql_fetch_array($seller_name_sql);
										$seller_name=$seller_name_row['name'];
										
										$buyer_name_sql=mysql_query("SELECT * FROM `seller` where id='$contract_buyer_id'");
						 ...
						 ?>
							  ...
							  <table border="1px" width="100%">
								...
								<tr style="text-align:center;">
									  ...
									  <td width="15%" ><input type="text" name="product_quantity[<?php echo $contract_number; ?><?php echo $product_id; ?>]" value="<?php echo $product_quantity; ?>" id="product_quantity<?php echo $id; ?>" style="width:50px;" onkeyup="cal_total_amount(<?php echo $broker_rate; ?>,<?php echo $id; ?>)" ></td>
